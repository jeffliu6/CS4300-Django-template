...
def parse_search(data, keys_vector):
    ...
    return {
        positive_effects_key: desired_lst,
        negative_effects_key: undesired_lst,
        medical_effects_key: medical_lst,
        aromas_key: aromas_lst,
        flavors_key: flavors_lst,
        keywords_key: valid_key_lst
    }
